...
public struct KeyboardInteractionEventArgs
{
...
public delegate void MultiKeyInteractionEventHandler(KeyboardInteractionEventArgs kie);
...
public class ControllerManager : MonoBehaviour
{
    ...
    public static event MultiKeyInteractionEventHandler MapTouchpadAxisChangedToArrowKeys;
    ...
    public static void OnTouchpadAxisChanged(KeyboardInteractionEventArgs e)
    {
        if (MapTouchpadAxisChangedToArrowKeys != null)
            MapTouchpadAxisChangedToArrowKeys(e);
    }
    ...
    //Dealing with multiple devices at once
    KeyboardInteractionEventArgs SetButtonEvent(float dir)
    {
        KeyboardInteractionEventArgs e;
        e.direction = dir;
    ...
    void Update()
    {
        ...
        {
            OnTouchpadAxisChanged(SetButtonEvent(1.0f));
        }
        ...
        //Left Grip Button Press
        if (left_controller != null && left_controller.GetPressDown(gripButton))
        {
